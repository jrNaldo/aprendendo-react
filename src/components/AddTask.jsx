export default function AddTask() {
    return(
        <div className="bg-slate-300 p-6 rounded-md ">
            ...
            <button className="bg-slate-600 w-full rounded-md p-2 mt-2 text-white border border-transparent transition-all duration-300 ease-in-out hover:bg-white hover:text-slate-600 hover:shadow-lg hover:border-slate-700 hover:border">Adicionar</button>
        </div>
    )
}